...
#   {"intent": intent_type_string, **intent.context}
#
# For example:
#   {"intent": "open_channel", "from_node": 1, "to_node": 2, "amount_sat": 500000}
#
...
def validate_intent_safety(intent: Dict[str, Any]) -> Tuple[bool, str]:
    ...
    Parameters:
      intent — a dict with at minimum an "intent" key (the intent type string)
               ...
               created by the Translator as:
                 {"intent": intent.intent_type, **intent.context}
    ...
    # The "intent" key is always required — it's the intent type string and
